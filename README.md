...
- 0.98 ROC-AUC and 0.93 PR-AUC for default prediction
...
Final candidates were compared on the same untouched validation split (data split 70/15/15 into train, validation and test):

| Candidate | Precision | Recall | F1 | F2 | Brier | Log loss |
|---|---|---|---|---|---|---|
| XGBoost + Platt scaling | 0.841 | 0.981 | 0.906 | 0.950 | 0.054 | 0.172 |
| XGBoost (raw) | 0.841 | 0.982 | 0.906 | 0.950 | 0.054 | 0.172 |
| Soft-voting ensemble | 0.839 | 0.982 | 0.905 | 0.950 | 0.054 | 0.175 |
| CatBoost (raw) | 0.841 | 0.980 | 0.905 | 0.949 | 0.055 | 0.179 |

![Untouched validation performance comparison](images/validation_comparison.png)
...
- **Earlier stage** (after data balancing, before interaction features were added): compared Logistic Regression, LightGBM, XGBoost, CatBoost and dense neural networks to choose final balanced dataset.
...
This repository documents the project.
